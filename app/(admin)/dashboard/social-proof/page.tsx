  ...
  testimonials: [
    {
      ...
      rating: "5",
      quote: "The system completely changed how we generate buyer leads. Instead of chasing random inquiries, we now speak with serious property buyers who are ready to visit and invest.",
    },
    {
      name: "Priya Nair",
      ...
      alt: "Property agent",
      rating: "5",
      quote: "Before Xigenis, we were spending ₹1L/month on portals with zero tracking. Now every rupee is accounted for and we see 4x more quality site visits.",
    },
    {
      name: "Amrita Verma",
      ...
      alt: "Broker",
      rating: "5",
      quote: "320+ qualified buyer leads in 60 days. ₹4.2 Cr property deals closed. The ROI from Xigenis has been phenomenal for our entire team.",
    },
    {
      name: "Vikram Desai",
      ...
      alt: "Channel partner",
      rating: "5",
      quote: "We closed 8 deals within the first quarter. The AI-driven follow-up system ensures no lead ever goes cold. This is the future of real estate marketing.",
    },
    {
      name: "Sneha Kapoor",
      ...
      rating: "5",
      quote: "Our site visit ratio jumped from 5% to 22%. The quality of leads is unmatched — every conversation is with a genuine buyer ready to invest.",
    },
    {
      name: "Rajesh Kumar",
      ...
      alt: "Marketing lead",
      rating: "5",
      quote: "The AI-driven follow-up system ensures no lead ever goes cold. This is the future of real estate marketing.",
    }
  ]
}
...
export default function SocialProofCmsPage() {
  ...
  useEffect(() => {
    async function fetchInitial() {
      const data = await getCmsContent('home', 'social-proof')
  ...
  const addTestimonial = () => {
    handleChange('testimonials', [...content.testimonials, { name: "New Person", src: "", alt: "Role", rating: "5", quote: "New Quote" }])
  }

  const removeTestimonial = (index: number) => {
    handleChange('testimonials', content.testimonials.filter((_, i) => i !== index))
  }
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>, arrayIndex: number) => {
    ...
    try {
      ...
      if (success && finalUrl) {
        handleTestimonialChange(arrayIndex, 'src', finalUrl)
  ...
  const handleSave = async () => {
    setIsSaving(true)
    const { success } = await upsertCmsContent('home', 'social-proof', content)
            ...
            <Card>
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                    <div className="space-y-1">
                        <CardTitle>Testimonials Array</CardTitle>
                        <CardDescription>First 6 avatars will be used for the floating background effect. All are part of the slider.</CardDescription>
                    </div>
                        ...
                        <div key={index} className="p-4 border rounded-md relative space-y-4 bg-muted/10 shadow-sm">
                            ...
                            <div className="grid grid-cols-2 gap-4 pr-16">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input type="number" min="1" max="5" value={item.rating} onChange={e => handleTestimonialChange(index, 'rating', e.target.value)} />
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-2 col-span-2">
                                    <Label>Quote</Label>
                                    <Textarea value={item.quote} onChange={e => handleTestimonialChange(index, 'quote', e.target.value)} />
                                </div>
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex gap-4 items-center">
                                    ...
                                    <div className="relative overflow-hidden shrink-0">
                                        <Button type="button" variant="outline" disabled={isUploadingValue === index}>
                                            {isUploadingValue === index ? <Loader2 className="w-4 h-4 mr-2 animate-spin" /> : <Upload className="w-4 h-4 mr-2" />}
                                            Upload
                                        </Button>
