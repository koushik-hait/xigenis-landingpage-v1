...
const WhyChooseUsFooter = () => {
  const stats = [
    {
      value: "₹47Cr+",
      label: "Property Pipeline Created",
    },
    {
      value: "2.4L+",
      label: "Verified Leads Delivered",
    },
    {
      value: "98%",
      ...
      <div className="container mx-auto max-w-7xl px-4">
        ...
        <div className="mb-16 space-y-4 text-center">
          ...
          <h2 className="font-serif text-4xl leading-tight text-gray-900 md:text-5xl">
            Built for Those Who Close, Not Chase.
          </h2>
          <p className="mx-auto max-w-2xl text-lg text-gray-500">
            We work exclusively with real estate professionals who want qualified pipeline — not vanity metrics.
          </p>
        </div>
