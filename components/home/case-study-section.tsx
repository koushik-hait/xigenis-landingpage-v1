...
const CaseStudies = ({ cmsContent }: CaseStudiesProps) => {
  const content = {
    ...
    projects: [
      {
        ...
        link: "https://link.yourmarketingai.com/widget/bookings/real-estate-growth-strategy-r-zfipu1-jvoty913",
      },
      {
        title: "Luxury Residential Project – Goa",
        leads: "3.4K+",
    ...
    moreLink: "https://link.yourmarketingai.com/widget/bookings/real-estate-growth-strategy-r-zfipu1-jvoty913",
    headingSize: "48",
    descriptionSize: "16",
    ...cmsContent,
  }
  ...
  return (
    <section id="case-studies" className="w-full overflow-hidden bg-[#FDFDFD] py-6 lg:py-12">
