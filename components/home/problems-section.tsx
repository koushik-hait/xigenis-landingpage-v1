    ...
    >
      <div className="relative z-10 mx-auto w-full">
        ...
        >
          ...
          <p
            className="mx-auto max-w-[460px] text-[15px] leading-[1.6] font-normal text-[#666] sm:text-[16px]"
        ...
        <section className="relative flex max-h-screen w-full items-center overflow-hidden bg-gradient-to-r from-white to-orange-50 pt-10 pb-8">
                ...
                <div className="flex hidden w-[85vw] flex-shrink-0 snap-center flex-col justify-center py-20">
                  <div className="px-4">
                    <div className="relative h-[600px] rounded-3xl bg-white/80 p-6 shadow-lg backdrop-blur-sm">
                      {/* Main Image */}
                      <div className="relative mb-6 h-[350px] w-full">
                        <Image
                      ...
                      {/* Floating Stats */}
                      <div className="absolute top-8 right-8 max-w-[140px] rounded-2xl bg-[#F97316] p-4 text-white shadow-lg">
                        <div className="font-serif text-2xl">{content.stat1Value}</div>
                        <div className="text-xs opacity-90">{content.stat1Label}</div>
                      </div>

                      <div className="absolute top-32 left-8 max-w-[140px] rounded-2xl bg-black p-4 text-white shadow-lg">
                        <div className="font-serif text-2xl">{content.stat2Value}</div>
                        <div className="text-xs opacity-80">{content.stat2Label}</div>
                      </div>

                      <div className="absolute right-8 bottom-8 max-w-[140px] rounded-2xl border border-gray-100 bg-white p-4 shadow-lg">
                        <div className="font-serif text-2xl text-[#D97706]">{content.stat3Value}</div>
                        <div className="text-[10px] tracking-wide text-gray-500 uppercase">{content.stat3Label}</div>
                      </div>

                      <div className="absolute bottom-8 left-8 max-w-[140px] rounded-2xl border border-gray-100 bg-white p-4 shadow-lg">
                        <div className="font-serif text-2xl text-[#D97706]">{content.stat4Value}</div>
                        <div className="text-[10px] tracking-wide text-gray-500 uppercase">{content.stat4Label}</div>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          {/* Desktop Layout */}
          <div className="max-w-8xl relative z-10 container mx-auto hidden px-4 sm:px-6 lg:block lg:px-8">
            <div className="flex flex-col items-center gap-12 lg:flex-row lg:gap-8">
              ...
              <div className="w-full space-y-8 lg:w-1/2">
                ...
                <p className="max-w-xl text-lg leading-relaxed text-gray-900">{content.introPara}</p>
              </div>
              ...
              <div className="relative mt-12 flex min-h-[600px] w-full items-end justify-center lg:mt-0 lg:min-h-[700px] lg:w-1/2">
                ...
                <div className="pointer-events-none absolute inset-0 z-20">
                  ...
                  <div className="pointer-events-auto absolute top-[30%] -left-4 max-w-[220px] transform rounded-3xl bg-[#F97316] p-6 text-white shadow-xl transition hover:scale-105 sm:left-0 lg:top-[40%] lg:-left-12">
                    ...
                    <p className="text-sm leading-tight font-medium opacity-90">{content.stat1Label}</p>
                  </div>
                  ...
                  <div className="pointer-events-auto absolute top-[20%] -right-4 max-w-[200px] transform rounded-3xl bg-black p-6 text-white shadow-xl transition hover:scale-105 sm:right-0 lg:top-[30%] lg:-right-8">
                    ...
                    <p className="text-xs leading-tight font-medium opacity-80">{content.stat2Label}</p>
                  </div>
