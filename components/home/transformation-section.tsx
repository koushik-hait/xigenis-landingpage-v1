...
export function TransformationSection({ cmsContent }: TransformationSectionProps) {
  ...
  const content = {
    ...
    ctaButtonLink: "https://link.yourmarketingai.com/widget/bookings/real-estate-growth-strategy-r-zfipu1-jvoty913",
    description1:
  ...
  return (
    <section id="transformation" className="relative w-full overflow-hidden bg-sky-100 py-10 lg:py-12">
